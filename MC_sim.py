...
import random
some_vals = [random.randrange(0, 10**6) for t in some_tickers]


# In[71]:

port_d = dict(zip(some_tickers, some_vals))
...
print portfolio.pca_risk(1, n_days=2, end_date = "01/15/15", window_length = 300)
print portfolio.unclean_risk(1, n_days=2, end_date = "01/15/15", window_length = 300)
print portfolio.historical_risk(1, n_days=2, end_date = "01/15/15", window_length = 300)


# In[74]:

print portfolio.pca_risk(1, n_days=2, end_date = "01/15/15", window_length = 800)
print portfolio.unclean_risk(1, n_days=2, end_date = "01/15/15", window_length = 800)
print portfolio.historical_risk(1, n_days=2, end_date = "01/15/15", window_length = 800)
